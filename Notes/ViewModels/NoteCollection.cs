...
namespace Notes.ViewModels
{
    ...
    public partial class NoteCollection : PagedCollectionViewWithQuery<Note, NoteQuery>
    {
        public NoteCollection(NoteQuery query, int total, IEnumerable<Note> items) : base(query, total, items)
        {
